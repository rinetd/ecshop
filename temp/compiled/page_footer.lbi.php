    ...
    <div class="ft_main">
      <div class="ft_links">
        <div class="ft_nav"> 
          ...
          <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_15725000_1474904246');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_15725000_1474904246']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?> 
          <a href="<?php echo $this->_var['nav_0_15725000_1474904246']['url']; ?>"  <?php if ($this->_var['nav_0_15725000_1474904246']['opennew'] == 1): ?>target="_blank" <?php endif; ?> <?php if (($this->_foreach['nav_bottom_list']['iteration'] <= 1)): ?> 
          class="noborder" 
          <?php endif; ?> rel="nofollow"><?php echo $this->_var['nav_0_15725000_1474904246']['name']; ?></a> 
