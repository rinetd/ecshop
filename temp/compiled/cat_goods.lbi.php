...
?>  
    ...
    <div class="pro_list">
      <ul class="cle">
		<?php $_from = $this->_var['cat_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_12600000_1474904246');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_12600000_1474904246']):
?>
        <li> <a href="<?php echo $this->_var['goods_0_12600000_1474904246']['url']; ?>" target="_blank">
          <p class="pic"> <img src="<?php echo $this->_var['goods_0_12600000_1474904246']['thumb']; ?>" style="display: inline;"></p>
          <h3><?php echo htmlspecialchars($this->_var['goods_0_12600000_1474904246']['short_name']); ?></h3>
          <p class="price">  
          <?php if ($this->_var['goods_0_12600000_1474904246']['promote_price'] != ""): ?>
          <?php echo $this->_var['goods_0_12600000_1474904246']['promote_price']; ?>
          <?php else: ?>
          <?php echo $this->_var['goods_0_12600000_1474904246']['shop_price']; ?>
          <?php endif; ?></p>
          </a> </li>
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </ul>
